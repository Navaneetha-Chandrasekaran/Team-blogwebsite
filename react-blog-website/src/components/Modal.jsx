            ...
            <div className='bg-indigo-700 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
                      ...
                      <form className='px-4'>
                           ...
                           <div>
                            ...
                            text-base font-semibold text-white outline-none'>Login</button>
                           </div>
                      </form>
                      <button  onClick={onCLose} className='bg-gray-300 hover:bg-gray-200 text-gray-800 font-semibold py-2 
                      px-4 rounded inline-flex items-center mt-8'>
                        close
                      </button>
            </div>
        </div>
