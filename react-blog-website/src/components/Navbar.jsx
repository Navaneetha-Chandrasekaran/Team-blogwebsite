...
import { FaBars,FaFacebook,FaXmark, FaTwitter } from "react-icons/fa6" 
    ...
    const closeModal=() =>{
        ...
        <header className='bg-black text-white fixed top-0 left-0 right-0'>
            <nav className='px-4 py-4 max-w-7xl mx-auto flex justify-between items-center'>
                <a href="/" className='text-xl font-bold text-white'>Blog<span className='text-orange-500'>web</span></a>
                ...
                {/* mobile menu btn ,display mobile sreen */}
                <div className=''>
